          ...
          <TableBody>
            {data.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell>{item?.treatment?.appointment?.appointmentId}</TableCell>
                <TableCell>{item?.dateIssued}</TableCell>
                <TableCell>
                  {item?.treatment?.appointment?.patient?.firstName +
                    " " +
                    item?.treatment?.appointment?.patient?.lastName}
                </TableCell>
                <TableCell>{item?.treatment?.appointment?.patient?.mobile}</TableCell>
