      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="p-6 shadow-md rounded-md">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <div>: {data?.treatment?.appointment.appointmentId}</div>

            <div className="font-medium">Appointment Date</div>
            <div>: {data?.treatment?.appointment.appointmentDate}</div>

            <div className="font-medium">Appointment Time</div>
            <div>: {data?.treatment?.appointment.appointmentTime}</div>

            <div className="font-medium">Appointment Status</div>
            <div>: {data?.treatment?.appointment.status}</div>

            <div className="font-medium">Registration Fee Rs.1000.00</div>
            <div>: {data?.treatment?.appointment.regFeeStatus}</div>
          </div>
        </div>
        ...
        <div className="p-6 shadow-md rounded-md">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <div>
              :{" "}
              {data?.treatment?.appointment.patient.firstName +
                " " +
                data?.treatment?.appointment.patient.lastName}
            </div>

            <div className="font-medium">Email Address</div>
            <div>: {data?.treatment?.appointment.patient.email}</div>

            <div className="font-medium">Contact Number</div>
            <div>: {data?.treatment?.appointment.patient.mobile}</div>

            <div className="font-medium">Address</div>
            <div>: {data?.treatment?.appointment.patient.address}</div>
          </div>
        </div>
      </div>
    </div>
